...
<template>
    <div class="table-container">
        <el-table :data="tableData">
            ...
            <el-table-column sortable prop="studentSection" label="班级" width="120" />
            <el-table-column sortable prop="attendanceId" label="考勤编号" width="120" />
            <el-table-column sortable prop="attendanceTime" label="考勤时间" width="250" />
            ...
            <el-table-column label="options" width="300">
                <template #default="scope">
                    <el-button link type="primary" size="small" @click="edit(scope.row.attendanceId)">Edit</el-button>
                    <el-button link type="danger" size="small" @click="remove(scope.row.attendanceId)">Delete</el-button>
                </template>
            </el-table-column>
        </el-table>
    </div>
